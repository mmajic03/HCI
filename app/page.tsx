    ...
    <main className="flex flex-col min-h-screen w-full items-center p-10 bg-[#9C8D71E8]">
      <div className="bg-[url('/header_image.jpg')] bg-cover bg-center h-[70vh] w-screen mt-4">
        <div className="bg-[#E4E0D3] h-[50%] w-[90%] sm:w-[70%] md:w-[50%] lg:w-[30%] mt-[100px] ml-4 sm:ml-6 md:ml-12 p-4 sm:p-6  flex flex-col items-start justify-around">
          <h2 className="font-kalam font-bold text-4xl text-black sm:text-2xl lg:text-3xl mb-0 break-words">
            Simple ingredients, endless possibilities...
          </h2>
          <p className="text-black font-kalam text-sm sm:text-sm lg:text-base break-words overflow-hidden -mt-[60px]">
      ...
      <div className="mt-1 flex flex-col lg:flex-row lg:gap-10 w-full">
        ...
        <h2 className="text-4xl font-kalam text-black font-bold text-center mb-8 mt-[20px] sm:mt-12 md:mt-16 lg:mt-[76px] w-full">Recommended recipes</h2>
      ...
      <h2 className="text-4xl font-kalam text-black font-bold text-center mt-[150px]">Popular recipes</h2>
      ...
      <h2 className="text-4xl font-kalam text-black font-bold text-center mt-[60px] mb-5">Top users</h2>
      <div className="border-b border-black w-full mb-7"></div>
      <TopUsers/>
